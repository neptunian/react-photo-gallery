...
var Gallery = _react2['default'].createClass({
    ...
    propTypes: {
        photos: _react2['default'].PropTypes.arrayOf(_react2['default'].PropTypes.shape({
            ...
            ar: _react2['default'].PropTypes.number.isRequired
        })).isRequired
    },
    ...
    componentDidMount: function componentDidMount() {
        ...
        this.handleResize = _lodash2['default'].debounce(this.handleResize, 400);
            ...
            for (var k = i; k < i + rowLimit; k++) {
                ...
                photoPreviewNodes.push(_react2['default'].createElement(
                    ...
                    _react2['default'].createElement(
                        ...
                        _react2['default'].createElement('img', { src: src, style: { display: 'block', border: 0 }, height: commonHeight, width: commonHeight * this.props.photos[k].ar, alt: '' })
                    )
                ));
            }
        }
...
},{"lodash":1,"react-dom":undefined,"react-images":undefined}]},{},[2])(2)
});