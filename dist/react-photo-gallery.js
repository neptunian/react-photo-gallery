    ...
    _createClass(Gallery, [{
        ...
        value: function render() {
            ...
            if (numHidden > 0) {
                ...
                var lastStyle = _extends({}, style);
                lastStyle.position = 'relative';
                lastStyle.cursor = 'pointer';
                lastStyle.margin = 0;
                photoPreviewNodes.push(_react2['default'].createElement(
                    'div',
                    { key: this.props.photos.length - 1, onClick: this.openLightbox.bind(this, photoPreviewNodes.length + 1), style: lastStyle },
                    lastItem,
                    _react2['default'].createElement(
                        'div',
                        { style: moreImagesStyle[0] },
                        _react2['default'].createElement(
                            'div',
                            { style: moreImagesStyle[1] },
                            _react2['default'].createElement(
                                'div',
                                { style: moreImagesStyle[2] },
                                '+',
                                numHidden
                            )
                        )
...
Gallery.propTypes = {
    ...
    limitPhotosInPreview: _react2['default'].PropTypes.number
};
